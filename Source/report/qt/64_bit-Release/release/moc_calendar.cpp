...
QT_MOC_LITERAL(3, 19, 16) // "on_close_clicked"

    },
    "Calendar\0finished\0\0on_close_clicked"
};
...
void Calendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Calendar::finished)) {
                *result = 0;
                return;
            }
        }
