/****************************************************************************
** Meta object code from reading C++ file 'logw.h'
**
...
#include <memory>
#include "../../../../qt/otchet/log/logw.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'logw.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject LogWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<ContexMenuWidget::staticMetaObject>(),
...
void *LogWidget::qt_metacast(const char *_clname)
{
    ...
    return ContexMenuWidget::qt_metacast(_clname);
}

int LogWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ContexMenuWidget::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
