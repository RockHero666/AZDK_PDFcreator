...
QT_MOC_LITERAL(1, 7, 11), // "log_message"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7) // "message"

    },
    "Parser\0log_message\0\0message"
};
...
void Parser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Parser::log_message)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Parser::log_message(const QString & _t1)
{
